...
public class P177_StudentScore {
	...
	public static void main(String[] args) {
		...
		P177_Student[] students = new P177_Student[3];
		students[0] = new P177_Student();
		students[0].setInfo("bmkim1", 2016001, 70, 80, 90);
		students[1] = new P177_Student();
		students[1].setInfo("bmkim2", 2016002, 60, 70, 80);
		students[2] = new P177_Student();
