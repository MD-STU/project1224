...
public class homeworkcheck0913 {
...
//		String PhoneNumber = getString("전화번호 : ", "^01[01]-\\d{4}-\\d{4}$", "전화번호 형식에 맞지 않습니다.");
		...
		//mbti
		//생일
		String BirthDay = getString("생일 : ", "^([1-9]|1[0-2])월 ([1-9]|[12][0-9]|3[0-1])일$", "생일 형식에 맞지 않습니다.");
		String BloodType = getString("혈액형 : ", "^[ABO][AB]$", "혈액형 형식에 맞지 않습니다.");
		String MBTI = getString("mbti : ", "^[EI][NS][TF][PJ]$", "mbti 형식에 맞지 않습니다.");
		/*
